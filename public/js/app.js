...
},{"../compiler":23,"../config":25,"../directives/internal":32,"../fragment/factory":54,"../parsers/directive":64,"../parsers/expression":65,"../parsers/path":66,"../parsers/template":67,"../parsers/text":68,"../util":76,"_process":4}],18:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../../util":76,"../internal/style":34,"_process":4}],37:[function(require,module,exports){
module.exports = {
  bind: function () {
    var el = this.el
...
},{"../config":25,"../util":76,"./array":61,"./dep":62}],64:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"./api/data":14,"./api/dom":15,"./api/events":16,"./api/global":17,"./api/lifecycle":18,"./directives/element":27,"./directives/public":42,"./filters":53,"./instance/events":56,"./instance/init":57,"./instance/lifecycle":58,"./instance/misc":59,"./instance/state":60,"./util":76,"_process":4}],80:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
var Dep = require('./observer/dep')
...
},{"./core/dependencies":82}],82:[function(require,module,exports){
/*
 * Load Vue & Vue-Resource.
 *
 * Vue is the JavaScript framework used by RBB.
 */
'use strict';
...
// Vue.http.headers.common['X-CSRF-TOKEN'] = RBB.csrfToken;
...
},{"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":2,"moment":3,"underscore":5,"vue":79,"vue-resource":7}]},{},[81]);
